...
\begin{enumerate}
  ...
  \item A positive forward premium/discount formula gives an annualised rate; multiply by $360/\text{days}$.
...
Upside potential & Eliminated & Retained (buyer can choose not to exercise) \\
...
\textit{Lecture material:} chapter7\_mfm\_slides2026-2; chapter8\_mfm\_slides2026-2; FINS3616 Lecture A M-transcript W4 A; FINS3616 Lecture B T-transcript W4 B. \textit{Tutorial material:} Quetions for Chs 7 and 8; Final Week 4 final Tutorial Solutions (Updated).
...
IRP & Interest rates $\leftrightarrow$ forward premium & $f_t = e_0 \times (1+r_h)^t/(1+r_f)^t$ & $\Delta\%f \approx r_h - r_f$ \\
...
\begin{itemize}[leftmargin=2em]
  ...
  \item[\cb] Identifying the direction of exchange-rate change given inflation/interest rate/growth changes
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Tutorial:} Quetions for Chs 7 and 8.pdf; Final Week 4 final Tutorial Solutions (Updated).pdf
